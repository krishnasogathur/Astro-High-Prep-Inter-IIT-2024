...
- `FASTER.py` 
Computes primary and secondary XRF contributions using tensorized integrals
- `get_constants_xrf_new_V2.py` 
Element-wise cross sections of photoelectric attenuation, total attenuation at characteristic line energies, and total attenuation at all energies.
- `rayleigh_compute.py`  
Scattering integral with the assumption of coherent scattering off a matrix of elements on Lunar surface.
